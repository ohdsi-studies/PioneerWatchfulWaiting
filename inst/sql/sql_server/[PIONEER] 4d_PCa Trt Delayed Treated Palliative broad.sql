...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45768763,937694,35807500,21603834,2777952,2777954,2777953,40487901,21603823,40490894,2109986,21603845,4057754,2211867,2211863,2211859,45763838,37312071,4342016,4341536,2109822,4234536,40222431,1315942,44816340,1309188,45892579,1378382,45775965,1718850,40224095)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45768763,937694,35807500,21603834,2777952,2777954,2777953,40487901,21603823,40490894,2109986,21603845,4057754,2211867,2211863,2211859,45763838,37312071,4342016,4341536,2109822,4234536,40222431,1315942,44816340,1309188,45892579,1378382,45775965,1718850,40224095)
  and c.invalid_reason is null
...
JOIN #Codesets codesets on ((de.device_concept_id = codesets.concept_id and codesets.codeset_id = 13))
) C
...
(
  select de.* 
  FROM @cdm_database_schema.DEVICE_EXPOSURE de
JOIN #Codesets codesets on ((de.device_concept_id = codesets.concept_id and codesets.codeset_id = 14))
) C
